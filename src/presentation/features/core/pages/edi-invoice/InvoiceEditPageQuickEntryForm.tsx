...
import { UserInputFieldContainer } from "./InvoicePage.styles";
...
function InvoiceEditPageQuickEntryForm(
  ...
  identifyFieldsToShowYellowBorder(form, form.getFieldsValue());
        ...
        <FormContainer>
          ...
          >
            ...
            <Row gutter={16}>
              ...
              <Col sm={24} lg={6}>
                <FullWidthFormControl>
                  <UserInputFieldContainer showBorder={showBorderOn_DTM_373_02}>
                    <Form.Item
                      name="DTM_373_02"
                      label={
                        <div className="form-label">
...
let showBorderOn_DTM_373_02 = false;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function identifyFieldsToShowYellowBorder(form: any, fieldsValue: any): void {
  const is_DTM_373_02_touched = form.isFieldTouched("DTM_373_02");
  const fieldValueIsEmpty_DTM_373_02 =
    !get(fieldsValue, "DTM_373_02") ||
    (get(fieldsValue, "DTM_373_02") && get(fieldsValue, "DTM_373_02") === "");

  showBorderOn_DTM_373_02 = is_DTM_373_02_touched
    ? false
    : fieldValueIsEmpty_DTM_373_02;
}
