...
const FormContainer = styled.div`
  ...
  // .transaction_set_identifier_code_01 > div.ant-row,
  // .transaction_set_control_number_02 > div.ant-row {
  //   display: flex;
  //   flex-direction: column;
  //   .ant-col {
  //     flex: none;
  //   }
  // }
  // #root_heading_transaction_set_header_ST > div.ant-row {
  //   display: flex;
  //   flex-direction: row;
  //   .ant-col {
  //     flex: none;
  ...
  // #root_heading_transaction_set_header_ST {
  ...
  // .date_01 > div.ant-row,
  // .date_03 > div.ant-row,
  // .purchase_order_number_04 > div.ant-row,
  // .release_number_05 > div.ant-row,
  // .change_order_sequence_number_06 > div.ant-row,
  // .invoice_number_02 > div.ant-row {
  //   display: flex;
  //   flex-direction: column;
  //   .ant-col {
  //     flex: none;
  //   }
  // }
  // #root_heading_beginning_segment_for_invoice_BIG > div.ant-row {
  //   display: flex;
  //   flex-direction: row;
  //   .ant-col {
  //     flex: none;
  ...
  // #root_heading_beginning_segment_for_invoice_BIG {
  //   .ant-row > div:first-child {
  //     width: 100%;
  //   }
  // }
