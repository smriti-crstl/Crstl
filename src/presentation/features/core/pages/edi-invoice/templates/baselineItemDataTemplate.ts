...
const baselineItemData = `{
  ...
  "item_physical_details_PO4": {
    "pack_01": "<%= data?.PO4_356_01 %>",
    "size_02": "<%= data?.PO4_357_02 %>",
    "unit_or_basis_for_measurement_code_03": "<%= data?.PO4_355_03 %>",
    "packaging_code_04": "<%= data?.PO4_103_04 %>",
    "gross_weight_per_pack_06": "<%= data?.PO4_384_06 %>",
    "unit_or_basis_for_measurement_code_07": "<%= data?.PO4_355_07 %>",
    "gross_volume_per_pack_08": "<%= data?.PO4_385_08 %>",
    "unit_or_basis_for_measurement_code_09": "<%= data?.PO4_355_09 %>",
    "length_10": "<%= data?.PO4_82_10 %>",
    "width_11": "<%= data?.PO4_189_11 %>",
    "height_12": "<%= data?.PO4_65_12 %>",
    "unit_or_basis_for_measurement_code_13": "<%= data?.PO4_355_13 %>",
    "inner_pack_14": "<%= data?.PO4_810_14 %>",
    "surface_layer_position_code_15": "<%= data?.PO4_752_15 %>",
    "assigned_identification_16": "<%= data?.PO4_350_16 %>",
    "assigned_identification_17": "<%= data?.PO4_350_17 %>",
    "number_18": "<%= data?.PO4_1470_18 %>"
  },
