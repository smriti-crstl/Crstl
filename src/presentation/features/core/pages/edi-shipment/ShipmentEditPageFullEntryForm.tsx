        ...
        <FormContainer>
          ...
          >
            ...
            >
              <FormHeaderContainer>
                <FormHeader>
                  <h2>New Ship Notice - Full Entry Form</h2>
                  <ButtonsContainer>
                    {resetDocBtn ? (
                      <Button
            ...
            <BorderedSubFormWrapper>
              ...
              {/* <h4>FOB F.O.B Related Instructions</h4>
              <Row gutter={16}>
                <Col sm={24} lg={8}>
                  <Form.Item
                    name="FOB_S_01_146"
              ...
              <Row gutter={16}>
                <Col sm={24} lg={8}>
                  <Form.Item
                    ...
                    label={
                      <div className="form-label">
                        ...
                        />
                        <span className="form-sub-label">(N1_S_01_98)</span>
                      </div>
                    }
                    rules={[
                      {
                  ...
                  >
                    <Select options={N1_98_OPTIONS_TARGET} />
                  </Form.Item>
                </Col>
                <Col sm={24} lg={8}>
                  <Form.Item
                    ...
                    label={
                      <div className="form-label">
                        ...
                        />
                        <span className="form-sub-label">(N1_S_02_93)</span>
                      </div>
                    }
                  >
                    <Input />
                  ...
                  <Form.Item
                    ...
                    label={
                      <div className="form-label">
                        ...
                        />
                        <span className="form-sub-label">(N1_S_03_66)</span>
                      </div>
                    }
                    rules={[
                      {
                  ...
                  <Form.Item
                    ...
                    label={
                      <div className="form-label">
                        ...
                        />
                        <span className="form-sub-label">(N1_S_04_67)</span>
                      </div>
                    }
                    rules={[
                      {
                  ...
                  <Form.Item
                    ...
                    label={
                      <div className="form-label">
                        ...
                        />
                        <span className="form-sub-label">(N1_S_05_706)</span>
                      </div>
                    }
                  >
                  ...
                  <Form.Item
                    ...
                    label={
                      <div className="form-label">
                        ...
                        />
                        <span className="form-sub-label">(N1_S_06_98)</span>
                      </div>
                    }
                  >
              ...
              <BorderedSubFormWrapper>
                ...
                <Row gutter={16}>
                  <Col sm={24} lg={8}>
                    ...
                    >
                      <Select options={PID_324_OPTIONS_TARGET} />
                    </Form.Item>
                  </Col>
                  <Col sm={24} lg={8}>
                    <Form.Item
                      name="HL_O_PID_02_750"
                      label={
                        <div className="form-label">
                  ...
                  <Col sm={24} lg={8}>
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: "Missing Agency Qualifier Code",
                        },
                      ]}
                    >
                      <Select
                        options={PID_559_OPTIONS_TARGET}
                        optionFilterProp="label"
                        showSearch
                      />
                    </Form.Item>
                  ...
                  <Col sm={24} lg={8}>
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: "Missing Product Description Code",
                        },
                      ]}
                    >
                      <Input />
