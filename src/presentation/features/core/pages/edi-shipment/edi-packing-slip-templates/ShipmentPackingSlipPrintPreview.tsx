...
import { packingSlipViewMap } from "./";

// import html2pdf from "html2pdf.js";

// console.log(html2pdf);

interface ShipmentPackingSlipPrintPreviewProps {
...
function ShipmentPackingSlipPrintPreview({
  setLoader,
  sortBy,
  tradingPartnerName = "",
  tradingPartnerFlavor = "",
}: ShipmentPackingSlipPrintPreviewProps) {
  ...
  return (
    <>
      ...
      <div style={{ display: "none" }}>
        <PackingSlipComponent data={labelData} ref={componentRef} />
      </div>
    </>
  );
}
export { ShipmentPackingSlipPrintPreview };
