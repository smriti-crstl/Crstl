...
function ShipmentPrintPageCVSDSD(
...
const ShipmentPrintPageWithRef = React.forwardRef(ShipmentPrintPageCVSDSD);

export { ShipmentPrintPageWithRef as ShipmentPrintPageCVSDSD };
