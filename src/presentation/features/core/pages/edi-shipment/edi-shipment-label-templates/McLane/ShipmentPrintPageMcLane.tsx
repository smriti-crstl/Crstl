...
function ShipmentPrintPageMcLane(
            ...
            <div className="page" key={shippingLabel.id} style={styles.page}>
              <table className="table" cellSpacing={0}>
                ...
                <tr style={{ height: "20mm" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <br />
                      {shippingLabel.carrierName
                        ? `B/L Number: ${shippingLabel.bolNumber || ""}`
                        : ``}
                    </Text>
                  </td>
                </tr>
                <tr style={{ height: "20mm" }}>
                  <td style={styles.contentTd} colSpan={2} valign="top">
                    <Text>
                      ...
                      <br />
                      {shippingLabel.upc ? `UPC#: ${shippingLabel.upc}` : ``}
                      <br />
                      {/* <br /> */}
                      {shippingLabel.dpci ? `SKU#: ${shippingLabel.dpci}` : ``}
                      <br />
                      {/* <br /> */}
                      {/* </strong> */}
                    </Text>
                ...
                <tr style={{ height: "32mm" }}>
                  ...
                  >
                    Serialized Shipping Container Barcode
                    <img
                      style={{
                        ...styles.img,
                        width: "100%",
...
const ShipmentPrintPageWithRef = React.forwardRef(ShipmentPrintPageMcLane);

export { ShipmentPrintPageWithRef as ShipmentPrintPageMcLane };
