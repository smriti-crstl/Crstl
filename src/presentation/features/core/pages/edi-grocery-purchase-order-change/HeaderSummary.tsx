...
import { formatDate } from "../edi-purchase-order-change/helpers";
...
export const HeaderSummary: React.FC<PublicProps> = ({ data }) => {
  const poDate = get(
    data,
    `${firstTransactionSet}.heading.purchase_order_change_type_G92.date_02`
  );
  ...
  return (
    <HeaderSummaryWrapper>
      <HeaderSummaryTable>
        <tr>
          <th scope="row">Purchase order change date:</th>
          <td>
