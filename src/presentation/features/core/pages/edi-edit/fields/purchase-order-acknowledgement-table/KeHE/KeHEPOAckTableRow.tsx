...
export const KeHEPOAckTableRow = ({
  data,
  onChange,
  rowIndex,
  statusCodeOptions,
  rejectReasonCodeOptions,
  errorSchema,
  idSchema,
  copyToAll,
  handleDeleteRow,
  ...
  const safeValues = {
    ...
    request_reference_number_06: removeUserInput(request_reference_number_06)
      ? request_reference_number_06
      : undefined,
  };
  ...
  const handleRejectReasonCodeChange = (value: string) => {
    const propertyPath = `${lineItemAckPath}.request_reference_number_06`;
    onChange(propertyPath, value);
  };
    ...
    <tr>
      ...
      <td>
        <RJSFErrorWrapper
          fieldErrors={get(
            errorSchema,
            `${lineItemAckPath}.request_reference_number_06`
          )}
        >
          <CellWrapper>
            <StyledSelect
              options={rejectReasonCodeOptions}
              value={safeValues.request_reference_number_06}
              onChange={(newValue) =>
                handleRejectReasonCodeChange(newValue as string)
              }
            ...
            <div
              ...
              onClick={() =>
                copyToAll(
                  `.${basePath}.request_reference_number_06`,
                  safeValues.request_reference_number_06
                )
              }
              aria-hidden="true"
            >
