...
const mainJson = `{
  ...
  "data": {
    "metadata": {
      ...
      "integration_id": null,
      "document_type": "856",
      "created_at": "2022-04-25T12:54:34.644Z",
      "updated_at": null,
      "created_by": "auto",
      "trading_partner_name": "Target",
      "source_document_id": "62569ef976d0fdb4296f7aa6",
      ...
      "interchanges": [
        {
          "interchange_control_header_ISA": {
            ...
            "interchange_date_09": "220425",
            "interchange_time_10": "1254",
              ...
              "transaction_sets": [
                {
                  ...
                  "heading": {
                    "transaction_set_header_ST": {
                      ...
                      "transaction_set_control_number_02": "3650"
                    },
                    "beginning_segment_for_ship_notice_BSN": {
                      "transaction_set_purpose_code_01": "00",
                      "shipment_identification_02": "USER_INPUT",
                      "date_03": "20220425",
                      "time_04": "1254",
                  ...
                  "detail": {
                    "hierarchical_level_HL_shipment": {
                      ...
                      "carrier_details_routing_sequence_transit_time_TD5": [
                        {
                          "routing_sequence_code_01": "origin_delivery_carrier_any_mode_B",
                          "identification_code_qualifier_02": "2",
                          "identification_code_03": "U_I",
                          "transportation_method_type_code_04": "U",
                          "routing_05": "USER_INPUT"
                        }
                      ],
                      "reference_identification_REF_BM": {
                        "reference_identification_qualifier_01": "BM",
                        "reference_identification_02": "USER_INPUT"
                      },
                    ...
                    "hierarchical_level_HL_order": {
                      ...
                      "purchase_order_reference_PRF": {
                        "purchase_order_number_01": "10000339247-0559"
                      },
                      "product_item_description_PID": [
                        {
                          "item_description_type_01": "S",
                          "agency_qualifier_code_03": "VI",
                          "product_description_code_04": "FL"
                        }
                      ],
                    ...
                    "hierarchical_level_HL_P_loop": [
                      {
                        "hierarchical_level_HL": {
                          "hierarchical_id_number_01": "3",
                          "hierarchical_parent_id_number_02": "2",
                          "hierarchical_level_code_03": "P"
                        },
                        "item_physical_details_PO4": { "pack_01": "24" },
                        "marks_and_numbers_MAN": [
                          {
                            "marks_and_numbers_qualifier_01": "GM",
                            "marks_and_numbers_02": "USER_INPUT"
                          }
                        ]
                      }
                    ],
                    "hierarchical_level_HL_I_loop": [
                      {
                        "hierarchical_level_HL": {
                        ...
                        "item_identification_LIN": {
                          ...
                          "product_service_id_qualifier_02": "upc_consumer_package_code_1_5_5_1_UP",
                          "product_service_id_03": "869657000012",
                          "product_service_id_qualifier_04": "buyers_catalog_number_CB",
                          "product_service_id_05": "094080085"
                        },
                        "item_detail_shipment_SN1": {
                          "number_of_units_shipped_02": "288",
                  ...
                  "summary": {
                    "transaction_totals_CTT": {
                      "number_of_line_items_01": "0"
                    },
                    "transaction_set_trailer_SE": {
                      "number_of_included_segments_01": "0",
                      "transaction_set_control_number_02": "0003"
                    }
                  }
                }
              ],
          ...
          "delimiters": { "element": "*", "segment": "~", "sub_element": ">" }
        }
      ],
      "__version": "jedi@2.0"
    }
