const SN1_03_355_OPTIONS = [
  ...
  },
  {
    ...
    notes: [
      {
        content:
          "The International Bittering Units (IBU) scale, is used to approximately quantify the bitterness of beer. This scale measures the amount of iso-alpha acids",
        paragraph_number: "1",
      },
    ],
  },
  ...
  },
  {
    ...
    notes: [
      {
        content:
          "One or more transport packages or other items contained on a platform making them suitable for transport, stacking, and storage as a unit.\nThe trade item above the pallet level used for transporting trade items for example Truck Load, Container, Rail Car, Ship, Etc.",
        paragraph_number: "1",
      },
    ],
  },
