...
const ELEMENT_235_OPTIONS_CVS_06 = [
  {
    value: "UI",
...
const ELEMENT_235_OPTIONS_TARGET_08 = [
  {
    value: "UA",
...
const ELEMENT_235_OPTIONS_TARGET_10 = [
  {
    value: "PI",
    label: "Purchaser's Item Code",
  },
];
const IT1_355_03_OPTIONS_CVS = [
  {
    value: "CA",
    label: "Case",
    paragraph_number: "1",
                ...
                <SubFormContainer key={field.key}>
                  ...
                  <Row gutter={16}>
                    ...
                    <Col sm={24} lg={6}>
                      ...
                      >
                        <Select
                          options={IT1_355_03_OPTIONS_CVS}
                    ...
                    <Col sm={24} lg={6}>
                      ...
                      >
                        <Select
                          options={ELEMENT_235_OPTIONS_CVS_06}
                          optionFilterProp="label"
                          showSearch
                        />
                      </Form.Item>
