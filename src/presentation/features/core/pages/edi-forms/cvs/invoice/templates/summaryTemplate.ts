...
const summary = `{
  "total_monetary_value_summary_TDS": {
    ...
    "amount_02": "<%= data?.TDS_610_02 %>",
    "amount_03": "<%= data?.TDS_610_03 %>",
    "amount_04": "<%= data?.TDS_610_04 %>"
  },
  "transaction_set_trailer_SE": {
    "number_of_included_segments_01": "<%= data?.SE_96_01 %>",
    "transaction_set_control_number_02": "<%= data?.SE_329_02 %>"
  },
  "carrier_detail_CAD": {
