...
import { ELEMENT_146_OPTIONS } from "./data/Element_146_options";
import { ELEMENT_309_OPTIONS } from "./data/Element_309_options";
import { ELEMENT_355_OPTIONS } from "./data/Element_355_options";
...
export const DTM_374_01_OPTIONS_TARGET = getTargetData(
  DTM_374_01_OPTIONS,
  "heading.140_DTM.01"
);
        ...
        <FormContainer>
          ...
          >
            ...
            >
              <FormHeaderContainer>
                <FormHeader>
                  <h2>New Invoice - Full Entry Form CVS</h2>
                  <ButtonsContainer>
                    {resetDocBtn ? (
                      <Button
            ...
            <Row gutter={16}>
              <Col sm={24} lg={6}>
                ...
                >
                  <Select
                    options={ITD_336_01_OPTIONS_CVS}
                    optionFilterProp="label"
                    showSearch
                  />
                </Form.Item>
              ...
              <Col sm={24} lg={6}>
                ...
                >
                  <Select
                    options={ITD_333_02_OPTIONS_CVS}
                    optionFilterProp="label"
                    showSearch
                  />
                </Form.Item>
                ...
                <Form.Item
                  ...
                  label={
                    <div className="form-label">
                      ...
                      />
                      <span className="form-sub-label">(FOB_146_01)</span>
                    </div>
                  }
                  rules={[
                    {
                      required: true,
                      message: "Shipment Method of Payment is required",
                    },
                  ]}
                >
                  <Select
                    options={ELEMENT_146_OPTIONS}
                    optionFilterProp="label"
                    showSearch
                  />
                </Form.Item>
                ...
                <Form.Item
                  ...
                  label={
                    <div className="form-label">
                      ...
                      />
                      <span className="form-sub-label">(FOB_309_02)</span>
                    </div>
                  }
                >
                  <Select
                    options={ELEMENT_309_OPTIONS}
                    optionFilterProp="label"
                    showSearch
                  />
                </Form.Item>
                ...
                <Form.Item
                  ...
                  label={
                    <div className="form-label">
                      ...
                      />
                      <span className="form-sub-label">(FOB_352_03)</span>
                    </div>
                  }
                >
                  <Input />
                ...
                <Form.Item
                  ...
                  label={
                    <div className="form-label">
                      ...
                      <span className="form-sub-label">(FOB_355_05)</span>
                    </div>
                  }
                >
                  <Select
                    options={ELEMENT_355_OPTIONS}
                    optionFilterProp="label"
                    showSearch
                  />
                </Form.Item>
              ...
              <Col sm={24} lg={6}>
                <Form.Item
                  ...
                  label={
                    <div className="form-label">
                      Location Qualifier
                      <span className="form-sub-label">(FOB_309_06)</span>
                    </div>
                  }
                >
                  <Select
              ...
              <Col sm={24} lg={6}>
                <Form.Item
                  ...
                  label={
                    <div className="form-label">
                      Description
                      <span className="form-sub-label">(FOB_352_09)</span>
                    </div>
                  }
                >
                  <Input />
                ...
                <Form.Item
                  ...
                  label={
                    <div className="form-label">
                      ...
                      />
                      <span className="form-sub-label">(TDS_610_03)</span>
                    </div>
                  }
                >
                  <Input />
                ...
                <Form.Item
                  ...
                  label={
                    <div className="form-label">
                      ...
                      />
                      <span className="form-sub-label">(TDS_610_04)</span>
                    </div>
                  }
                >
                  <Input />
