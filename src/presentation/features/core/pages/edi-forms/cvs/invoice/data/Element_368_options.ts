const ELEMENT_368_OPTIONS = [
  ...
  },
  {
    ...
    notes: [
      {
        content:
          "Quantity of a product which has been ordered by a buyer in an unfinished state that is available for instructions for the final manufacturing process to complete for delivery to the customer",
        paragraph_number: "1",
      },
    ],
  },
