  ...
  return (
    <ViewModeContainer ref={downloadComponentRef}>
      <BusinessViewRenderer
        ...
        config={businessViewConfig[CoreEDIDocumentNumber.GroceryPurchaseOrder]}
...
const EdiGroceryPOViewWithRef = forwardRef(EdiGroceryPOView);

export { EdiGroceryPOViewWithRef as default };
