...
import { useGetFacebookAdsTrend } from "domain/interactors/marketing";
...
function FacebookAdMetricsTrend() {
  const { data, isLoading, isError } = useGetFacebookAdsTrend();
  ...
  const cardTitle = (
    <HeaderContainer>
      <div>
        <HeaderWrapper>
          <span>Facebook Ads key metrics</span>
          <StyledTimeSpan>
