...
import { GetBusinessNameRes } from "domain/entity/integrations/models";
import data from "./data.json";

const url = `${serviceDefinitions.CORE}/${ENDPOINTS.GET_BUSINESS_NAME}`;
...
function customDataHandler(data: GetBusinessNameRes) {
