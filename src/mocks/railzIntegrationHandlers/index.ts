...
import { GetRailzIntegrationRes } from "domain/entity/integrations/models";
import data from "./data.json";

const url = `${serviceDefinitions.CORE}/${ENDPOINTS.GET_RAILZ_INTEGRATIONS}`;
...
function customDataHandler(data: GetRailzIntegrationRes) {
