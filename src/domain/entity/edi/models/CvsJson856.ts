...
export interface HierarchicalLevelHLILoopItemPhysicalDetailsPO4 {
  ...
  width_11: string;
  height_12: string;
  unit_or_basis_for_measurement_code_13: string;
...
export interface CarrierDetailsEquipmentTD3 {
  equipment_description_code_01: string;
...
export interface HierarchicalLevelHLShipment {
  ...
  name_N1_SF: NameN1Loop;
  name_N1_ST: NameN1Loop;
  date_time_reference_DTM: DateTimeReferenceDTM[];
  date_time_reference_DTM_011: DateTimeReferenceDTM;
  date_time_reference_DTM_067: DateTimeReferenceDTM;
  carrier_details_quantity_and_weight_TD1: CarrierDetailsQuantityAndWeightTD1[];
  carrier_details_equipment_TD3: CarrierDetailsEquipmentTD3[];
}
